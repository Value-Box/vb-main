...
// available offer
 ...
 <div className="w-full p-7.5 bg-[#FCFCFC] hidden md:flex justify-center">
  ...
  <a 
    ...
    onClick={(e) => { 
      e.preventDefault(); 
      setIsInstalmentModalOpen(true); setIsClosing(false)
    }}
  >
    View more details
  </a>
          ...
          <div className="flex gap-2.5 items-baseline">
           ...
           <div className="flex gap-2.5 items-center ">
           <span className="flex p-2.5 flex-col justify-center items-center gap-2.5 rounded-[5px] border border-[#CCC] bg-[#FCFCFC] cursor-pointer"  onClick={(e) => { 
           e.preventDefault();  setIsCardModalOpen(true); setIsClosing(false)}}>
           <svg xmlns="http://www.w3.org/2000/svg" width="34" height="24" viewBox="0 0 36 36" fill="none">
          <path d="M9 18H27M18 27L18 9" stroke="#999999" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
           </svg>
            </span>
             <span className="text-black text-[18px] font-medium cursor-pointer"  onClick={(e) => { 
           e.preventDefault();  setIsCardModalOpen(true); setIsClosing(false)}}>Add New Card</span>            
...
/>
  ...
  <g clipPath="url(#clip0_7110_93676)">
...
<path d="M8.11644 15.165L4.40004 12.0903C4.09559 11.8384 4.05296 11.3874 4.30483 11.0829L5.13718 10.0768C5.38905 9.77232 5.84004 9.72969 6.14448 9.98157L8.17914 11.6649L14.6499 2.4923C14.8777 2.16942 15.3241 2.09232 15.647 2.32012L16.7139 3.07289C17.0368 3.30069 17.1139 3.7471 16.8861 4.06998L9.15711 15.0262C8.91686 15.3667 8.43755 15.4307 8.11644 15.165Z" fill="#EEA500"/>
 ...
 <div className="text-sm flex flex-col gap-2.5">
  ...
  <g clipPath="url(#clip0_7129_97056)">
...
>
  ...
  <path fillRule="evenodd" clipRule="evenodd" d="M10.1569 12.7116L4.49994 18.3686L3.08594 16.9546L8.03594 12.0046L3.08594 7.05463L4.49994 5.64062L10.1569 11.2976C10.3444 11.4852 10.4497 11.7395 10.4497 12.0046C10.4497 12.2698 10.3444 12.5241 10.1569 12.7116Z" fill="#12B76A"/>
</svg>
      </p>
  ...
  <g clipPath="url(#clip0_7171_91263)">
  ...
  <g clipPath="url(#clip0_7171_91266)">
  ...
  <g clipPath="url(#clip0_7171_91272)">
  ...
  <g clipPath="url(#clip0_7171_91277)">
  ...
  <g clipPath="url(#clip0_7171_91280)">
  ...
  <g clipPath="url(#clip0_7171_91291)">
...
{/* Mobile View */}
 ...
 <div className="max-w-md mx-auto bg-[#F2F2F2] shadow-lg rounded-lg border">
      ...
      <div className="flex items-center border-b border-[#F2F2F2] bg-[#FCFCFC] px-2 py-4">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
     <path d="M21 12L15 18L21 24" stroke="#333333" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
       </svg></NavLink></button>
     ...
     {cartData.map((store, index) => (
                 store.items.some(item=>item.delivery==='Standard')&&(
                   ...
                   <h3 className="font-semibold text-gray-700 flex gap-1.5 items-center">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                     <path d="M3 21.0002H5M5 21.0002H19M5 21.0002V9.32824M21 21.0002H19M19 21.0002V9.32824M5 9.32824C4.96261 9.30677 4.92592 9.28409 4.89 9.26024L4.35 8.90024C3.96826 8.64562 3.68568 8.26746 3.54967 7.82921C3.41366 7.39096 3.43249 6.91926 3.603 6.49324L4.497 4.25724C4.64549 3.88615 4.90176 3.56806 5.23276 3.34401C5.56376 3.11995 5.9543 3.00022 6.354 3.00024H17.646C18.0457 3.00022 18.4362 3.11995 18.7672 3.34401C19.0982 3.56806 19.3545 3.88615 19.503 4.25724L20.397 6.49324C20.5675 6.91926 20.5863 7.39096 20.4503 7.82921C20.3143 8.26746 20.0317 8.64562 19.65 8.90024L19.11 9.26024C19.0741 9.28409 19.0374 9.30677 19 9.32824M5 9.32824C5.32305 9.51483 5.69184 9.60733 6.0647 9.59532C6.43757 9.5833 6.79964 9.46724 7.11 9.26024L9 8.00024L10.89 9.26024C11.2187 9.47952 11.6049 9.59654 12 9.59654C12.3951 9.59654 12.7813 9.47952 13.11 9.26024L15 8.00024L16.89 9.26024C17.2004 9.46724 17.5624 9.5833 17.9353 9.59532C18.3082 9.60733 18.677 9.51483 19 9.32824" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                     <path d="M13.998 20.9999V15.9999C13.998 15.4694 13.7873 14.9607 13.4123 14.5857C13.0372 14.2106 12.5285 13.9999 11.998 13.9999C11.4676 13.9999 10.9589 14.2106 10.5838 14.5857C10.2088 14.9607 9.99805 15.4694 9.99805 15.9999V20.9999" stroke="#1A1A1A" strokeWidth="1.5"/>
                   </svg> {store.store}  
                     </label> </h3>
                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
         <path d="M10 8L14 12L10 16" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
         ...
         <g clipPath="url(#clip0_7192_111265)">
           <path d="M13.6126 1.33317C11.6215 2.96428 10.4918 4.41273 10.2233 5.6785C9.95487 6.94428 9.91432 8.14939 10.1017 9.29384L13.6673 9.29384L7.84898 14.6665L2.33398 9.29384L5.72298 9.29384C5.73965 7.17762 6.49887 5.3785 8.00065 3.8965C9.50243 2.41473 11.3731 1.56028 13.6126 1.33317Z" stroke="#F04438" strokeLinejoin="round"/>
         </g>
         <defs>
         ...
         <path d="M11.6654 7H2.33203" stroke="#999999" strokeWidth="1.16667" strokeLinecap="round"/>
       </svg>
                           </button>
...
<h3 className="text-[16px] font-semibold text-black">Delivery Type</h3>
  ...
  <g clipPath="url(#clip0_7228_113897)">
  ...
  <path d="M8.33301 6.66671L11.6663 10L8.33301 13.3334" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg></span>
  </div>
