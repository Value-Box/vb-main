...
function AddToCart() {
  ...
  return (
    <div className='bg-[#FCFCFC] '>
      {!isMobile?(
        <div className='flex gap-6 p-4 xl:p-8'>
        <div className='w-[70%]'>
  ...
  <rect width="20" height="20" fill="white"/>
    ...
    {cartData.map((store, index) => (
      <div key={index} className="bg-[#FCFCFC] border border-[#F2F2F2] rounded-[10px] p-4">
        <h3 className="font-semibold text-gray-700 flex gap-1.5 items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
     ...
     <div className='bg-[#CCC] h-px my-4'></div>
        {store.items.map((item) => (
          ...
          <div key={item.id} className="flex items-center gap-2 xl:gap-4 mt-2 w-full">
            ...
            <CheckBox id={item.id} // onChange={() => toggleSelect(item.id)}
             />
...
<li className="flex items-center">
            ...
            {store.items.map((item) => (
              ...
              <div key={item.id} className="flex items-center gap-2 xl:gap-4 mt-2 w-full">
                ...
                <div className='flex gap-2'>
                    ...
                    <span className='text-xs text-[#999] bg-[#F2F2F2] px-4 py-1 rounded-[5px] inline-block '>Free Delivery</span>
                </div>
  ...
  <path d="M11.6654 7H2.33203" stroke="#999999" stroke-width="1.16667" stroke-linecap="round"/>
                  ...
                  <span className="px-0 text-sm">1</span>
                  <button className="px-1 py-1 cursor-pointer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
