      ...
      items: [
        {
          id: 1,
          image: Image2,
          title: "Men's Trendy Platform Shoes",
          price: "5,699",
          originalPrice: "9,999",
          discount: "-40%",
          rating: 4.5,
    ...
    <div className='sm:flex gap-2 sm:gap-4 p-3 sm:p-6 max-w-[1920px] mx-auto'>
        ...
        <div key={index} className="mb-5">
          ...
          <div className="flex gap-4 flex-wrap">
            {history.items.slice(0,visibleProducts).map((item,index) => (
              <div key={index} className="flex-1 min-w-[200px] max-w-[230px] bg-white rounded-lg overflow-hidden duration-400 hover:shadow-lg group ">
              ...
              />
              <NavLink to="/SingleProduct" className='flex items-center gap-1 bg-white px-3 py-2 whitespace-nowrap rounded-full absolute bottom-2 left-2  opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
      ...
      <button onClick={showMore} className="mt-5 border border-[#666] text-natural-black font-medium px-7 py-2 rounded-[5px] mx-auto">
        View More
      </button>
      </div>
        </div>
