...
<div className="border border-[#999] w-[100%] my-2 xl:my-0 xl:w-[40%] rounded-lg overflow-hidden shadow">
  ...
  <path d="M7.70083 7.20536C7.8231 6.95759 8.17636 6.95759 8.29863 7.20536L9.29366 9.22149C9.34223 9.31989 9.4361 9.38809 9.54466 9.40386L11.7696 9.72716C12.043 9.76689 12.1522 10.1029 11.9543 10.2957L10.3444 11.8651C10.2658 11.9417 10.2299 12.052 10.2485 12.1601L10.6286 14.3761C10.6753 14.6484 10.3894 14.856 10.1449 14.7275L8.15483 13.6812C8.05773 13.6302 7.94173 13.6302 7.84463 13.6812L5.85456 14.7275C5.61003 14.856 5.3242 14.6484 5.3709 14.3761L5.75096 12.1601C5.76953 12.052 5.73366 11.9417 5.6551 11.8651L4.04513 10.2957C3.84726 10.1029 3.95646 9.76689 4.22986 9.72716L6.4548 9.40386C6.56336 9.38809 6.65723 9.31989 6.7058 9.22149L7.70083 7.20536Z" fill="#FCEDCD" stroke="#EEA500" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.9996 1.59973H3.99957V4.93306L7.99957 6.59973L11.9996 4.93306V1.59973Z" fill="#FCEDCD" stroke="#EEA500" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
</svg> Top Rated</span>
          </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="bg-blue-900 text-white px-4 py-1 rounded-full flex items-center gap-2 hover:bg-blue-800">
    ...
    {products.slice(0,5).map((items, index) => (
          ...
          <div key={index} className="bg-white rounded-lg overflow-hidden flex-[1_1_250px] max-w-[300px] duration-300 hover:shadow-lg select-none">
                <img
            ...
            Super<span className='text-[#33539B]'>Deal</span>
                  ...
                  <span className="text-red-500 px-2">•</span> 
                  <span className='flex flex-row items-center text-[12px] flex-wrap font-bold text-[#F04438]'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <g clip-path="url(#clip0_7006_127218)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.4081 8.46428L4.69393 3.75011L5.87226 2.57178L9.99727 6.69678L14.1223 2.57178L15.3006 3.75011L10.5864 8.46428C10.4302 8.6205 10.2182 8.70827 9.99727 8.70827C9.77629 8.70827 9.56437 8.6205 9.4081 8.46428Z" fill="#1A1A1A"/>
  </g>
  <defs>
  ...
  <path d="M6 12L10.2426 16.2426L18.7275 7.75732" stroke="#12B76A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <ul className="mt-2 space-y-2">
        <li className="flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M12 22.4967C12 22.4967 20.9986 19.4971 20.9986 11.9983" stroke="#EEA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M20.9986 11.9984V2.99977C20.9986 2.99977 17.9991 1.5 12 1.5" stroke="#EEA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.9996 22.4967C11.9996 22.4967 3.00101 19.4971 3.00101 11.9983" stroke="#EEA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M3.00098 11.9984V2.99977C3.00098 2.99977 6.00051 1.5 11.9996 1.5" stroke="#EEA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M17.9984 5.99927C11.9993 10.4986 10.4995 16.4976 10.4995 16.4976C10.4995 16.4976 8.99977 14.7075 7.5 13.4981" stroke="#EEA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
