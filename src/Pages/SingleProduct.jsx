...
function ProductPage() {
  ...
  const reviews = [
    {
      ...
      productImg: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080",
    },
    {
      id: 2,
      name: "Michael Smith",
      ...
      productImg: "https://images.unsplash.com/photo-1505751171710-1f6d0ace5a85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMnx8aGVhZHBob25lfGVufDB8MHx8fDE3MjEzMDM2OTB8MA&ixlib=rb-4.0.3&q=80&w=1080",
    },
    {
      id: 3,
      name: "Emma Williams",
      ...
      productImg: "https://images.unsplash.com/photo-1484704849700-f032a568e944?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw0fHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080",
    },
    {
      id: 4,
      name: "David Brown",
      review: "Great Product There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour",
      userImg: "https://randomuser.me/api/portraits/men/8.jpg",
      productImg: "https://images.unsplash.com/photo-1496957961599-e35b69ef5d7c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080",
    },
    {
      id: 5,
      name: "Sophia Miller",
      ...
      productImg: "https://images.unsplash.com/photo-1528148343865-51218c4a13e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwzfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080",
    },
  ];
  ...
  const scroll = (direction) => {
    if (scrollRef.current) {
      const scrollAmount = 150; // Kitna scroll ho ek click pe
      scrollRef.current.scrollLeft += direction === "left" ? -scrollAmount : scrollAmount;
    }
  };
  return (
    <>
    <div className="flex items-start flex-col md:flex-row p-6 gap-6 max-w-[1920px] mx-auto">
      {/* Left Section - Images */}
      <div className="flex w-max flex-row-reverse gap-4 sticky top-[12%]">
        <img
          src={mainImage}
          alt="Product"
...
<span className="text-[#1A1A1A] ml-1">4.3</span> <span className="text-[#666] ml-1">20 Reviews | 1,000+ Sold</span>
        ...
        {/* Quantity & Buttons */}
        <div className="flex items-center gap-2 mt-4 bg-[#FEF6E6] p-2 rounded-lg">
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
  <path d="M7.58864 11.9546C6.96068 11.9546 6.39167 11.5846 6.13694 11.0107C5.78112 10.2089 6.14262 9.27052 6.94437 8.91471L16.2767 4.77307C17.097 4.40898 18.0333 4.40898 18.8537 4.77307L28.1859 8.91471C28.76 9.16944 29.1299 9.73845 29.1299 10.3664C29.1299 11.2436 28.4188 11.9546 27.5417 11.9546H7.58864Z" fill="#EEA500" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M9 15.9C9 15.4029 9.40294 15 9.9 15H11.1C11.5971 15 12 15.4029 12 15.9V26.1C12 26.5971 11.5971 27 11.1 27H9.9C9.40294 27 9 26.5971 9 26.1V15.9Z" fill="#FEF6E6" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M18.6 15H17.4C16.9029 15 16.5 15.4029 16.5 15.9V26.1C16.5 26.5971 16.9029 27 17.4 27H18.6C19.0971 27 19.5 26.5971 19.5 26.1V15.9C19.5 15.4029 19.0971 15 18.6 15Z" fill="#FEF6E6" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M24 15.9C24 15.4029 24.4029 15 24.9 15H26.1C26.5971 15 27 15.4029 27 15.9V26.1C27 26.5971 26.5971 27 26.1 27H24.9C24.4029 27 24 26.5971 24 26.1V15.9Z" fill="#FEF6E6" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M16.5081 30.7639H6.84375" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M23.0196 31.1499C26.6159 31.1499 29.5313 28.2345 29.5313 24.6381C29.5313 21.0417 26.6159 18.1263 23.0196 18.1263C19.4232 18.1263 16.5078 21.0417 16.5078 24.6381C16.5078 28.2345 19.4232 31.1499 23.0196 31.1499Z" fill="#EEA500" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M20.9957 23.7466C21.7151 23.7466 22.2981 23.1635 22.2981 22.4441C22.2981 21.7249 21.7151 21.1418 20.9957 21.1418C20.2764 21.1418 19.6934 21.7249 19.6934 22.4441C19.6934 23.1635 20.2764 23.7466 20.9957 23.7466Z" fill="#FEF6E6" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M25.2819 28.5425C26.0012 28.5425 26.5842 27.9594 26.5842 27.24C26.5842 26.5208 26.0012 25.9377 25.2819 25.9377C24.5627 25.9377 23.9795 26.5208 23.9795 27.24C23.9795 27.9594 24.5627 28.5425 25.2819 28.5425Z" fill="#FEF6E6" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M25.6458 21.9211L20.4297 27.8013" stroke="#002882" stroke-width="1.5" stroke-linecap="round"/>
</svg>
<p className="text-[#1A1A1A] inline">Installment Offers available up to 36 months 
    <Link className="text-[#002882] underline inline ml-1">View more details</Link></p>
        </div>
        <div className="flex gap-4 mt-4 bg-[#CCC] h-[1px]"></div>
        <p className="text-[#333] text-lg font-semibold ">Cabinet Color: EU Ship</p>
          ...
          {colors.map((color) => (
            <button
              ...
              className={`px-3 py-1 rounded-md border font-medium ${
                selectedColor === color ? "border border-[#EEA500] text-[#1A1A1A]" : "border border-[#CCC] text-[#666] "
              }`}
            >
              {color}
            </button>
        ...
        <div className="flex gap-2">
          {sizes.map((size) => (
            <button
              ...
              className={`px-3 py-1 rounded-md border font-medium ${
                selectedSize === size ? "border border-[#EEA500] text-[#1A1A1A]" : "border border-[#CCC] text-[#666] "
              }`}
            >
              {size}
            </button>
  ...
  <defs>
    <clipPath id="clip0_6998_126789">
      <rect width="20" height="20" fill="white"/>
            ...
            <p className="text-[#1A1A1A] inline">Johar town, Lahore 
    <Link className="text-[#002882] underline inline ml-1">Change</Link></p>
        </div>
        </div>

        <div className="px-3 py-2 bg-gradient-to-b from-[#FCEDCD] to-[#FFF] flex gap-2 items-center">
          <span className="bg-[linear-gradient(90deg,#0032A3_0%,#1A51CB_25%,#3B66C8_50%,#1A51CB_75%,#0032A3_100%)] rounded-sm py-1 px-2 text-[#FCFCFC] ">VB MALL</span>
          <span className="text-[#1A1A1A] font-semibold ">ValueBox Commitment</span>
        </div>
  ...
  <path d="M11 11.25H6M11 8.25H6M8.5 17.25C8.50044 17.6219 8.41789 17.9892 8.25839 18.3252C8.09888 18.6611 7.86642 18.9573 7.57796 19.192C7.2895 19.4268 6.9523 19.5942 6.59094 19.6821C6.22957 19.77 5.85315 19.7762 5.48909 19.7002C5.12504 19.6242 4.78253 19.4679 4.48652 19.2428C4.19051 19.0176 3.94846 18.7293 3.77802 18.3987C3.60757 18.0682 3.51302 17.7038 3.50125 17.332C3.48948 16.9603 3.5608 16.5907 3.71 16.25C3.9402 15.7244 4.34422 15.2939 4.85423 15.031C5.36424 14.768 5.94919 14.6884 6.51091 14.8057C7.07262 14.923 7.57689 15.2299 7.93908 15.675C8.30127 16.1201 8.49932 16.6762 8.5 17.25ZM20.5 17.25C20.5004 17.6219 20.4179 17.9892 20.2584 18.3252C20.0989 18.6611 19.8664 18.9573 19.578 19.192C19.2895 19.4268 18.9523 19.5942 18.5909 19.6821C18.2296 19.77 17.8531 19.7762 17.4891 19.7002C17.125 19.6242 16.7825 19.4679 16.4865 19.2428C16.1905 19.0176 15.9485 18.7293 15.778 18.3987C15.6076 18.0682 15.513 17.7038 15.5013 17.332C15.4895 16.9603 15.5608 16.5907 15.71 16.25C15.783 16.074 15.88 15.909 16 15.76C16.2599 15.4075 16.6081 15.1298 17.0096 14.9548C17.4111 14.7799 17.8517 14.714 18.2868 14.7637C18.7219 14.8134 19.1362 14.9769 19.4879 15.2379C19.8396 15.4989 20.1163 15.848 20.29 16.25C20.43 16.565 20.502 16.906 20.5 17.25Z" stroke="#1A1A1A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <span className="flex gap-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 9.61305 20.0518 7.32387 18.364 5.63604C16.6761 3.94821 14.3869 3 12 3C9.61305 3 7.32387 3.94821 5.63604 5.63604C3.94821 7.32387 3 9.61305 3 12Z" stroke="#1A1A1A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M12 7V12L15 15" stroke="#1A1A1A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg> Standard Delivery: <span className="font-semibold">DEC 06 - 16</span>
        </span>
  ...
  <path d="M10 8L14 12L10 16" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="px-3">
        <div className="flex gap-4 my-4 bg-[#CCC] h-[1px]"></div>
        <span className="flex text-[#333] font-bold items-center">Select Quantity</span>
...
<div className="flex space-x-4 mt-4 mb-6">
  ...
  <path d="M16.544 3.74988C13.5009 3.74988 12.0009 6.74988 12.0009 6.74988C12.0009 6.74988 10.5009 3.74988 7.45775 3.74988C4.98463 3.74988 3.02619 5.81894 3.00088 8.28785C2.94931 13.4127 7.06635 17.0572 11.579 20.12C11.7034 20.2047 11.8504 20.2499 12.0009 20.2499C12.1513 20.2499 12.2983 20.2047 12.4228 20.12C16.9349 17.0572 21.052 13.4127 21.0009 8.28785C20.9756 5.81894 19.0171 3.74988 16.544 3.74988Z" stroke="#666666" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div className="flex items-start flex-col md:flex-row p-6 gap-6 max-w-[1920px] mx-auto">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M20 2H4C2.9 2 2 2.9 2 4V19.59C2 20.48 3.08 20.93 3.71 20.3L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2ZM13.57 11.57L12.45 14.01C12.4102 14.0973 12.3462 14.1713 12.2655 14.2232C12.1848 14.2751 12.0909 14.3027 11.995 14.3027C11.8991 14.3027 11.8052 14.2751 11.7245 14.2232C11.6438 14.1713 11.5798 14.0973 11.54 14.01L10.42 11.57L7.98 10.45C7.89271 10.4102 7.8187 10.3462 7.7668 10.2655C7.7149 10.1848 7.6873 10.0909 7.6873 9.995C7.6873 9.89907 7.7149 9.80517 7.7668 9.72449C7.8187 9.64382 7.89271 9.57977 7.98 9.54L10.42 8.42L11.54 5.98C11.5798 5.89271 11.6438 5.8187 11.7245 5.7668C11.8052 5.7149 11.8991 5.6873 11.995 5.6873C12.0909 5.6873 12.1848 5.7149 12.2655 5.7668C12.3462 5.8187 12.4102 5.89271 12.45 5.98L13.57 8.42L16.01 9.54C16.0973 9.57977 16.1713 9.64382 16.2232 9.72449C16.2751 9.80517 16.3027 9.89907 16.3027 9.995C16.3027 10.0909 16.2751 10.1848 16.2232 10.2655C16.1713 10.3462 16.0973 10.4102 16.01 10.45L13.57 11.57Z" fill="#1A1A1A"/>
</svg>
  ...
  {sections.map((section) => (
        ...
        {ratings.map((rating) => (
          <div key={rating.stars} className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Percentage */}
              <div className="text-gray-600 text-sm">{rating.percentage}%</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="overflow-x-auto w-full max-w-[400px] scrollbar-hidden cursor-grab active:cursor-grabbing select-none" 
...
{/* Scroll Indicator */}
      ...
      <div className="mt-10 space-y-10">
        ...
        <div id="reviews" className="flex flex-wrap gap-2">
          ...
          {reviews.map((review) => (
            <div
              key={review.id}
              className="mb-4 w-[49%] p-4 bg-white border rounded-lg border-[#CCC] items-center gap-4"
            >
              <div className="flex gap-2">
              <img
                src={review.userImg}
  ...
  <path d="M4.59673 0.914511L3.37617 3.50013L0.645336 3.91609C0.155617 3.9903 -0.0406439 4.62108 0.314496 4.98237L2.29019 6.99384L1.8229 9.83528C1.73879 10.3489 2.25655 10.7336 2.69019 10.4934L5.13318 9.15177L7.57617 10.4934C8.00981 10.7317 8.52757 10.3489 8.44345 9.83528L7.97617 6.99384L9.95186 4.98237C10.307 4.62108 10.1107 3.9903 9.62102 3.91609L6.89019 3.50013L5.66963 0.914511C5.45094 0.453631 4.81729 0.447772 4.59673 0.914511Z" fill="#E59819"/>
  <path d="M21.5967 0.914511L20.3762 3.50013L17.6453 3.91609C17.1556 3.9903 16.9594 4.62108 17.3145 4.98237L19.2902 6.99384L18.8229 9.83528C18.7388 10.3489 19.2565 10.7336 19.6902 10.4934L22.1332 9.15177L24.5762 10.4934C25.0098 10.7317 25.5276 10.3489 25.4435 9.83528L24.9762 6.99384L26.9519 4.98237C27.307 4.62108 27.1107 3.9903 26.621 3.91609L23.8902 3.50013L22.6696 0.914511C22.4509 0.453631 21.8173 0.447772 21.5967 0.914511Z" fill="#E59819"/>
  <path d="M38.5967 0.914511L37.3762 3.50013L34.6453 3.91609C34.1556 3.9903 33.9594 4.62108 34.3145 4.98237L36.2902 6.99384L35.8229 9.83528C35.7388 10.3489 36.2565 10.7336 36.6902 10.4934L39.1332 9.15177L41.5762 10.4934C42.0098 10.7317 42.5276 10.3489 42.4435 9.83528L41.9762 6.99384L43.9519 4.98237C44.307 4.62108 44.1107 3.9903 43.621 3.91609L40.8902 3.50013L39.6696 0.914511C39.4509 0.453631 38.8173 0.447772 38.5967 0.914511Z" fill="#E59819"/>
  <path d="M55.5967 0.914511L54.3762 3.50013L51.6453 3.91609C51.1556 3.9903 50.9594 4.62108 51.3145 4.98237L53.2902 6.99384L52.8229 9.83528C52.7388 10.3489 53.2565 10.7336 53.6902 10.4934L56.1332 9.15177L58.5762 10.4934C59.0098 10.7317 59.5276 10.3489 59.4435 9.83528L58.9762 6.99384L60.9519 4.98237C61.307 4.62108 61.1107 3.9903 60.621 3.91609L57.8902 3.50013L56.6696 0.914511C56.4509 0.453631 55.8173 0.447772 55.5967 0.914511Z" fill="#E59819"/>
  <path d="M72.5967 0.914511L71.3762 3.50013L68.6453 3.91609C68.1556 3.9903 67.9594 4.62108 68.3145 4.98237L70.2902 6.99384L69.8229 9.83528C69.7388 10.3489 70.2565 10.7336 70.6902 10.4934L73.1332 9.15177L75.5762 10.4934C76.0098 10.7317 76.5276 10.3489 76.4435 9.83528L75.9762 6.99384L77.9519 4.98237C78.307 4.62108 78.1107 3.9903 77.621 3.91609L74.8902 3.50013L73.6696 0.914511C73.4509 0.453631 72.8173 0.447772 72.5967 0.914511Z" fill="#E59819"/>
</svg>
              </div>
              </div>
              <div className="flex-1">
                
                <p className="text-[#667479] ">{review.review}</p>
              </div>
              <img
        ...
        <div id="specification" className="p-6 bg-gray-100 rounded-lg">
        ...
        <div className="w-max  border rounded-lg border-[#CCC] mt-6 md:mt-0 sticky top-[12%]">
        <div className="px-3 py-6">
        <div className="flex items-center justify-between gap-15">
            <span className="flex text-[#333] font-bold items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
