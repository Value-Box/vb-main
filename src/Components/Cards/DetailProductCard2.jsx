...
function DetailProductCard2({ products,style='' ,loadProducts}) {
  ...
  return (
    ...
    {products.slice(0,loadProducts).map((product,index) => (
        <div key={index} className={`bg-white rounded-lg overflow-hidden min-w-[150px] sm:min-w-[250px] md:min-w-[240px] max-w-[350px] xl:min-w-[270px] duration-400 hover:shadow-lg group select-none ${style}`}>
