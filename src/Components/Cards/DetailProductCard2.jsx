...
function DetailProductCard2({ products,style='' ,loadProducts}) {
  ...
  return (
    <>
    {products.slice(0,loadProducts).map((product,index) => (
        <div key={index} className={`bg-white rounded-lg overflow-hidden flex-1 min-w-[270px] sm:min-w-[250px] md:min-w-[300px] max-w-[400px] xl:min-w-[350px] duration-400 hover:shadow-lg group select-none ${style}`}>
