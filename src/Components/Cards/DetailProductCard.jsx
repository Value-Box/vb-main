...
function DetailProductCard({products}) {
    console.log('Detail Product Card',products)
  ...
  return (
    <>
    <div class="bg-[#FCFCFC] p-3 sm:p-8 flex gap-5">
    {products.map((items, index) => (
          
          <div key={index} className="bg-white rounded-lg overflow-hidden min-w-[250px] duration-400 hover:shadow-lg  ">
                <img
