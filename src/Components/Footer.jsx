...
function Footer() {
  ...
  <div className="max-w-[1920px] px-4 py-4 md:py-8 lg:py-12 xl:py-16 md:px-8 lg:px-12 xl:px-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:grid-cols-3 xl:grid-cols-5">
   
        <div>
          <p className="font-medium text-[#EEA500] text-base md:text-lg lg:text-xl flex justify-between items-baseline"
          onClick={()=>{toggleDropdown('companyInfo')}}>Company Info 
          
          <svg className={`sm:hidden transition-transform duration-300 ${openDropDown === 'companyInfo'?'rotate-180':''}`} transform="scale(1.5)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M12.0008 15L7.75781 10.758L9.17281 9.34399L12.0008 12.172L14.8288 9.34399L16.2438 10.758L12.0008 15Z" fill="#EEA500"/>
         </svg>
    ...
    <nav
  className={`right-0 z-10 flex flex-col space-y-2 text-sm text-[#CCC] font-medium 
    transition-transform transition-opacity duration-500 ease-in-out overflow-hidden origin-top
    ${openDropDown === 'companyInfo' ? 'opacity-100 scale-y-100 mt-4' : 'opacity-0 scale-y-0 h-[0px]'}`}
>
  <a href="">About ValueBox</a>
  <a className="text-[#666]" href="">ValueBox Se Ab Zindagi Asan!</a>
  ...
  <a href="">Contact Us</a>
          ...
          <nav className="hidden sm:flex flex-col mt-4 space-y-2 lg:text-base text-sm text-[#CCC] font-medium">
            <a className=" " href="">
              About ValueBox
            </a>
        ...
        <div className='flex flex-col sm:items-end md:items-center'>
          <div>
          <p className="font-medium text-[#EEA500] text-base md:text-lg lg:text-xl flex justify-between items-baseline"
           onClick={()=>{toggleDropdown('customerService')}}>Customer Service 
           <svg className={`sm:hidden transition-transform duration-300 ${openDropDown === 'customerService'?'rotate-180':''}`} transform="scale(1.5)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path  d="M12.0008 15L7.75781 10.758L9.17281 9.34399L12.0008 12.172L14.8288 9.34399L16.2438 10.758L12.0008 15Z" fill="#EEA500"/>
</svg></p>
<nav className={`right-0 z-10 flex flex-col space-y-2 text-sm text-[#CCC] font-medium 
    transition-transform transition-opacity duration-500 ease-in-out overflow-hidden origin-top
    ${openDropDown === 'customerService' ? 'opacity-100 scale-y-100 mt-4' : 'opacity-0 scale-y-0 h-[0px]'}`}>
            <a className=" " href="">
        ...
        <div className='flex flex-col md:items-center'>
          <div>
          <p className="font-medium text-[#EEA500] text-base md:text-lg lg:text-xl flex justify-between items-baseline"
          onClick={()=>{toggleDropdown('help')}}>Help 
          <svg className={`sm:hidden transition-transform duration-300 ${openDropDown === 'help'?'rotate-180':''}`} transform="scale(1.5)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M12.0008 15L7.75781 10.758L9.17281 9.34399L12.0008 12.172L14.8288 9.34399L16.2438 10.758L12.0008 15Z" fill="#EEA500" />
</svg></p>
<nav className={`right-0 z-10 flex flex-col space-y-2 text-sm text-[#CCC] font-medium 
    transition-transform transition-opacity duration-500 ease-in-out overflow-hidden origin-top
    ${openDropDown === 'help' ? 'opacity-100 scale-y-100 mt-4' : 'opacity-0 scale-y-0 h-[0px]'}`}>
            <a className=" " href="">
  ...
  <path  fillRule="evenodd" clipRule="evenodd" d="M9.76441 2.99801C10.0458 2.68376 10.3903 2.43237 10.7754 2.26027C11.1605 2.08816 11.5776 1.99921 11.9994 1.99921C12.4212 1.99921 12.8383 2.08816 13.2234 2.26027C13.6085 2.43237 13.953 2.68376 14.2344 2.99801L14.9344 3.78001C15.0344 3.89192 15.1584 3.97987 15.2971 4.03734C15.4357 4.09482 15.5855 4.12034 15.7354 4.11201L16.7854 4.05401C17.2065 4.03089 17.6277 4.09679 18.0215 4.24741C18.4154 4.39804 18.7731 4.63 19.0712 4.92818C19.3694 5.22635 19.6014 5.58404 19.752 5.97791C19.9026 6.37177 19.9685 6.79296 19.9454 7.21401L19.8874 8.26401C19.8792 8.41372 19.9048 8.56335 19.9623 8.70182C20.0198 8.8403 20.1076 8.96408 20.2194 9.06401L21.0024 9.76401C21.3168 10.0454 21.5684 10.3899 21.7406 10.7752C21.9128 11.1604 22.0018 11.5776 22.0018 11.9995C22.0018 12.4215 21.9128 12.8387 21.7406 13.2239C21.5684 13.6091 21.3168 13.9536 21.0024 14.235L20.2194 14.935C20.1075 15.0351 20.0196 15.159 19.9621 15.2977C19.9046 15.4363 19.8791 15.5861 19.8874 15.736L19.9454 16.786C19.9685 17.2071 19.9026 17.6283 19.752 18.0221C19.6014 18.416 19.3694 18.7737 19.0712 19.0718C18.7731 19.37 18.4154 19.602 18.0215 19.7526C17.6277 19.9032 17.2065 19.9691 16.7854 19.946L15.7354 19.888C15.5857 19.8798 15.4361 19.9054 15.2976 19.9629C15.1591 20.0204 15.0353 20.1082 14.9354 20.22L14.2354 21.003C13.954 21.3174 13.6095 21.569 13.2243 21.7412C12.8391 21.9134 12.4219 22.0024 11.9999 22.0024C11.578 22.0024 11.1608 21.9134 10.7756 21.7412C10.3903 21.569 10.0458 21.3174 9.76441 21.003L9.06441 20.22C8.96438 20.1081 8.84043 20.0202 8.70177 19.9627C8.56311 19.9052 8.41328 19.8797 8.26341 19.888L7.21341 19.946C6.79236 19.9691 6.37117 19.9032 5.9773 19.7526C5.58344 19.602 5.22575 19.37 4.92758 19.0718C4.6294 18.7737 4.39744 18.416 4.24681 18.0221C4.09619 17.6283 4.03029 17.2071 4.05341 16.786L4.11141 15.736C4.11958 15.5863 4.09399 15.4367 4.03652 15.2982C3.97905 15.1597 3.89118 15.0359 3.77941 14.936L2.99741 14.236C2.68299 13.9546 2.43146 13.6101 2.25926 13.2249C2.08706 12.8397 1.99805 12.4225 1.99805 12.0005C1.99805 11.5786 2.08706 11.1614 2.25926 10.7762C2.43146 10.3909 2.68299 10.0464 2.99741 9.76501L3.77941 9.06501C3.89132 8.96498 3.97927 8.84103 4.03674 8.70237C4.09422 8.56371 4.11974 8.41388 4.11141 8.26401L4.05341 7.21401C4.03029 6.79296 4.09619 6.37177 4.24681 5.97791C4.39744 5.58404 4.6294 5.22635 4.92758 4.92818C5.22575 4.63 5.58344 4.39804 5.9773 4.24741C6.37117 4.09679 6.79236 4.03089 7.21341 4.05401L8.26341 4.11201C8.41312 4.12019 8.56274 4.09459 8.70122 4.03712C8.8397 3.97965 8.96348 3.89178 9.06341 3.78001L9.76441 2.99801ZM15.7064 8.29301C15.8939 8.48054 15.9992 8.73485 15.9992 9.00001C15.9992 9.26518 15.8939 9.51949 15.7064 9.70701L9.70641 15.707C9.51781 15.8892 9.26521 15.99 9.00301 15.9877C8.74081 15.9854 8.49 15.8802 8.30459 15.6948C8.11919 15.5094 8.01402 15.2586 8.01174 14.9964C8.00946 14.7342 8.11025 14.4816 8.29241 14.293L14.2924 8.29301C14.4799 8.10554 14.7342 8.00023 14.9994 8.00023C15.2646 8.00023 15.5189 8.10554 15.7064 8.29301ZM9.49941 8.00001C9.10159 8.00001 8.72006 8.15805 8.43875 8.43935C8.15745 8.72066 7.99941 9.10219 7.99941 9.50001V9.51001C7.99941 9.90784 8.15745 10.2894 8.43875 10.5707C8.72006 10.852 9.10159 11.01 9.49941 11.01H9.50941C9.90724 11.01 10.2888 10.852 10.5701 10.5707C10.8514 10.2894 11.0094 9.90784 11.0094 9.51001V9.50001C11.0094 9.10219 10.8514 8.72066 10.5701 8.43935C10.2888 8.15805 9.90724 8.00001 9.50941 8.00001H9.49941ZM14.4994 13C14.1016 13 13.7201 13.158 13.4388 13.4394C13.1574 13.7207 12.9994 14.1022 12.9994 14.5V14.51C12.9994 14.9078 13.1574 15.2894 13.4388 15.5707C13.7201 15.852 14.1016 16.01 14.4994 16.01H14.5094C14.9072 16.01 15.2888 15.852 15.5701 15.5707C15.8514 15.2894 16.0094 14.9078 16.0094 14.51V14.5C16.0094 14.1022 15.8514 13.7207 15.5701 13.4394C15.2888 13.158 14.9072 13 14.5094 13H14.4994Z" fill="#FCFCFC"/>
      ...
      <div>
      <p className="font-medium text-base md:text-lg lg:text-xl text-[#EEA500]">Connect with ValueBox</p>
        
        <div className="flex mt-1 md:mt-2 lg:mt-3 space-x-6 lg:text-base text-[#CCC] font-medium">
          <a
            className="bg-gradient-to-r from-[#0032A3] via-[#3B66C8] to-[#0032A3] p-2 rounded-full"
            href=""
            target="_blank"
            rel="noreferrer"
          >
            <span className="sr-only"> Facebook </span>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 14 28" fill="none">
  <path d="M9.33333 16H12.6667L14 10.6667H9.33333V7.99999C9.33333 6.62666 9.33333 5.33332 12 5.33332H14V0.853323C13.5653 0.79599 11.924 0.666656 10.1907 0.666656C6.57067 0.666656 4 2.87599 4 6.93332V10.6667H0V16H4V27.3333H9.33333V16Z" fill="url(#paint0_linear_10928_15579)"/>
  <defs>
    <linearGradient id="paint0_linear_10928_15579" x1="0" y1="14" x2="14" y2="14" gradientUnits="userSpaceOnUse">
  ...
  <path d="M17.1335 3.76C16.2221 2.7195 15.7198 1.38324 15.7202 0H11.6002V16.5333C11.5684 17.428 11.1907 18.2755 10.5466 18.8973C9.90242 19.519 9.04214 19.8665 8.14687 19.8667C6.25354 19.8667 4.68021 18.32 4.68021 16.4C4.68021 14.1067 6.89354 12.3867 9.17354 13.0933V8.88C4.57354 8.26667 0.546875 11.84 0.546875 16.4C0.546875 20.84 4.22688 24 8.13354 24C12.3202 24 15.7202 20.6 15.7202 16.4V8.01333C17.3909 9.21313 19.3967 9.85686 21.4535 9.85333V5.73333C21.4535 5.73333 18.9469 5.85333 17.1335 3.76Z" fill="url(#paint0_linear_10928_15583)"/>
  <defs>
    <linearGradient id="paint0_linear_10928_15583" x1="0.546875" y1="12" x2="21.4535" y2="12" gradientUnits="userSpaceOnUse">
      <stop stopColor="#FFC136"/>
      <stop offset="0.197568" stopColor="#FAC142"/>
      <stop offset="0.525" stopColor="#FFD168"/>
      <stop offset="0.771328" stopColor="#F5BC3A"/>
  ...
  <defs>
    ...
    <div className='text-[#CCC] lg:mt-10 mt-5 flex lg:flex-row flex-col gap-5 lg:gap-15 xl:gap-25'>
        <div>
        <p className="font-medium text-base md:text-lg lg:text-xl flex justify-between items-baseline">
        Security Certifications
        </p>
        <div className='flex gap-3 mt-2 flex-wrap lg:flex-nowrap'>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={visa} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={mastercard} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={discover} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={americanexpress} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={jcb} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={applePay} alt="" /></span>
            <span className='bg-white rounded-sm xl:px-4 px-2 py-1 xl:py-2'><img className='w-8 md:w-11 h-6 sm:h-7 md:h-9 object-contain' src={GooglePay} alt="" /></span>
        </div>
        </div>
        <div>
        <p className="font-medium text-base md:text-lg lg:text-xl flex justify-between items-baseline">
    ...
    <hr className="border-t border-[#CCC] lg:mt-10 mt-5 lg:mb-10 mb-5" />
    <div className='flex flex-col md:flex-row lg:text-lg text-base gap-5 items-center justify-between'>
        <img src={Logo} className='w-[90px] lg:w-[128px]' alt="" />
        <div className='text-[#CCC] flex 2xl:gap-10 xl:gap-8 lg:gap-6 gap-4'>
            <a href="">English</a>
            <a href="">Privacy</a>
            <a href="">Privacy Policy</a>
        </div>
        <div className='text-[#CCC]'>
        <p className="text-xs">© 2024 ValueBox. All Rights Reserved.</p>
